<%@ Page Title="Cadastre-se" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="WebUI.SysSala.Account.Register" %>
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
                <asp:Button runat="server" OnClick="CreateUser_Click" Text="OK" CssClass="btn btn-default" />
            </div>
        </div>
    </div>
</asp:Content>
